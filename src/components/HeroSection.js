...
function HeroSection({ userRole }) {
  const location = useLocation();
  const { email, password } = location.state || {};

  // Check email and password to determine the role
  let role;
  if (email === 'A@gmail.com' && password === '123') {
    role = 'admin';
  } else if (email === 'B@gmail.com' && password === '456') {
    role = 'accountant';
  }
        ...
        <div className="hero min-h-screen bg-base-200">
          <div className="hero-content text-center">
            <div className="max-w-md">
              ...
              <p className="py-6">Welcome to 9 Education ERP! A leader in professional IIT Coaching. Please Login to continue...</p>
